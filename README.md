 ...
 * @LastEditTime: 2022-10-07 00:32:30
 * @Description: 
...
- 部署步骤:
  ...
  4. 此时会将File和Position打印出来,例如:![](images/master.png)将这两个值在 ==./slave-1/cnf/cluster.sql== 和 ==./slave-2/cnf/cluster.sql==中修改一下( ==master_log_file='mysql-bin.000003',master_log_pos=830== ,这两个),因为是在容器中运行的缘故,所以可能作者设置的参数本身就是当时mysql容器内的参数
